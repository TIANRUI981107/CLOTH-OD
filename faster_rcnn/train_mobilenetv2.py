...
def create_model(num_classes):
    ...
    Args:
        num_classes (int): obj_classes + background
...
def main():
    ...
    # ---> load train datasets <---
    train_dataset = VOCDataSet(VOC_root, "2007", data_transform["train"], "train.txt", provided_cls_path=False)
    train_sampler = None
    ...
    for param in model.backbone.parameters():  # frozen backbone's parameters
